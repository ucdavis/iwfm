...
def hdf2bud_stream(hdf_file, output_file,
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Convert IWFM Stream Budget HDF5 file to text format',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Basic usage with defaults (converts to acres and acre-feet)
  python hdf2bud_stream.py C2VSimFG_Stream_Budget.hdf output.txt

  # Specify custom conversion factors
  python hdf2bud_stream.py input.hdf output.txt --area-fact 0.000022957 --vol-fact 0.000022957

  # Use different units
  python hdf2bud_stream.py input.hdf output.txt --area-units "hectares" --vol-units "cubic meters"
...
Default conversion factors:
  ...
  Volume: 0.000022957 (cu ft to acre-ft, exact: 1/43560)
    ...
    if args.hdf_file:
        ...
        # Interactive mode
        print("IWFM Stream Budget HDF5 to Text Converter")
