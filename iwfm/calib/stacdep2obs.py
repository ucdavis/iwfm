# stacdep2obs.py
# Convert IWFM Stream Node Budget to the SMP file format for 
# use by PEST.
...
def process_budget(budget_file, cwidth=12):
    """ process_budget() - Read IWFM Stream Nodes budget file and process into
        a table of individual stream node budgets and a list of headers
