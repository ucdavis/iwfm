# test_hdf5_hdf2xlsx_rz.py
# Tests for hdf5/hdf2xlsx_rz.py - Convert IWFM Root Zone Budget HDF5 to Excel format
...
class TestHdf2xlsxRzImports:
    """Tests for hdf2xlsx_rz imports."""

    def test_import_from_hdf5(self):
        """Test import from iwfm.hdf5."""
        from iwfm.hdf5 import hdf2xlsx_rz
        assert callable(hdf2xlsx_rz)
    ...
    def test_function_has_docstring(self):
        ...
        assert hdf2xlsx_rz.__doc__ is not None
        assert 'root zone' in hdf2xlsx_rz.__doc__.lower() or 'excel' in hdf2xlsx_rz.__doc__.lower() or 'hdf5' in hdf2xlsx_rz.__doc__.lower()


class TestHdf2xlsxRzSignature:
    """Tests for hdf2xlsx_rz function signature."""

    def test_function_signature(self):
        """Test that hdf2xlsx_rz has correct function signature."""
        from iwfm.hdf5.hdf2xlsx_rz import hdf2xlsx_rz

        sig = inspect.signature(hdf2xlsx_rz)
...
class TestHdf2xlsxRzDependencies:
    """Tests for hdf2xlsx_rz dependencies."""
